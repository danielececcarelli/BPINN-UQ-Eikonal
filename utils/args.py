...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        """Initializer"""
        super(Parser, self).__init__(description='Bayesian PINN')
        ...
        self.add_argument('--method', type=str, default="SVGD", required=True, help="""Methods to use for BPINN. Available:
        																			  ...
        																			  -NUTS (No U-Turn Sampler -> MCMC method)
        ...
        self.add_argument('--batch_size', type=int, help='batch size for training collocation. Need to be <= (Num of Domain)*prop_collocation')
        ...
        self.add_argument('--save_flag', type=bool, help='flag for save results (or send it in trash)')
        self.add_argument('--save_every_n_epochs', type=int, help="""flag for saving plot and results every n epochs;
                                                                                set it to zero if you dont want to save""")
